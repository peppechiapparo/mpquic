...
- [ ] **4. Binario in drift client/VPS.** Client `c95df26c...` ≠ VPS `4ac2bed3...`. La checklist richiede md5 identici (TS-016: il drift di binario è la via delle regressioni silenziose). Prima di allineare va stabilito quale versione è quella giusta: la baseline sarà quella validata sul banco locale TBOX-EVO.
